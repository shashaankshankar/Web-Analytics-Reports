...
- Complete the operator's Testing-mode Google OAuth grant and verify property discovery. Before public self-service publishing, supply approved platform homepage/privacy/terms pages on an owned authorized domain, complete Google verification, and make an explicit production decision. The web client, secrets, KMS, and restricted Testing-mode authorization path are already live.
