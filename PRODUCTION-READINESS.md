...
| Database resilience | Regional HA | Cloud SQL is regional, deletion-protected, encrypted-only, retains 30 automated backups, and has seven-day point-in-time recovery. Query Insights is enabled without client-address capture. |
