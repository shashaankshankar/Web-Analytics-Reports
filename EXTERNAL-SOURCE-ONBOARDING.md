...
| Search Console | Verified property matching `https://thehouseofdentalwp.com`, read access for the runtime identity or approved OAuth connection | Query retention/privacy review; the current discovery attempt is denied with 403 |
