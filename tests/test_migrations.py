...
def test_all_incremental_migrations_record_their_version():
    ...
    for version in ("002_production","003_phase4_tenant_isolation","004_phase5_reporting_oauth","005_retention_offboarding","006_external_sources","007_external_sync_provenance","008_source_connection_management","009_oauth_assignment_management"):
